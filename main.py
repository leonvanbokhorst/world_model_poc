...
def run_simulation():
    ...
    if final_belief.lower().strip('.') == actual_goal:
        print("Conclusion: The LearningAgent successfully inferred the TargetAgent's goal.")
    else:
        print("Conclusion: The LearningAgent did not correctly infer the TargetAgent's goal.")
